...
def multi_task_regression_regression(vaihingen_batch):
    ...
    x1_vaihingen = dense_block(x, 4, 12, 0.2, name='up_db_0_vaihingen_reg1')
    x2_vaihingen = dense_block(x, 4, 12, 0.2, name='up_db_0_vaihingen_reg2')
      
    with tf.compat.v1.variable_scope('regression_vaihingen_1'):
    ...
    with tf.compat.v1.variable_scope('regression_vaihingen_2'):
    ...
    return x_vaihingen_reg1, x_vaihingen_reg2 # , argmax_vaihingen
