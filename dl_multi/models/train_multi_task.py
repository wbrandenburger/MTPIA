...
def train(
    ...
    img, output_1, output_2 = dl_multi.tftools.augmentation.rnd_crop_rotate_90_with_flips_height(data[0], data[2], data[1], param_train["image-size"], 0.95, 1.1)
    ...
    objectives.update([truth_batch, height_batch], list(pred))
